...
public class UpnpIOServiceImpl implements UpnpIOService, RegistryListener {
    ...
    @SuppressWarnings("unchecked")
    @Override
    public Map<String, String> invokeAction(@Nullable UpnpIOParticipant participant, @Nullable String serviceID,
            @Nullable String actionID, @Nullable Map<String, String> inputs) {
